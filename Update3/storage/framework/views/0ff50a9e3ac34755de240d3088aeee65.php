                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-center slide-pic p-5" style="background-color: #5c5555;">
                            <div class="container p-5">
                                <img src="https://images.pexels.com/photos/11298681/pexels-photo-11298681.jpeg" id="image" width="300px" height="450px" style="box-shadow: 10px 10px 10px 0px rgba(0,0,0,0.75);">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\tubesKelompok1-app\resources\views/try.blade.php ENDPATH**/ ?>
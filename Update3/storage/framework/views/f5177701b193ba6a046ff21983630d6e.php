    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 text-center mb-5 p-5 border">
                ...
                <?php if(is_array($kesimpulan) && isset($kesimpulan['moist'])): ?>
                    <p>Moisturizer: <?php echo e($kesimpulan['moist']); ?></p>
                <?php endif; ?>

                <?php if(is_array($kesimpulan) && isset($kesimpulan['serum'])): ?>
                    <p>Serum: <?php echo e($kesimpulan['serum']); ?></p>
                <?php endif; ?>

                <?php if(is_array($kesimpulan) && isset($kesimpulan['ss'])): ?>
                    <p>Sunscreen: <?php echo e($kesimpulan['ss']); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\tubesKelompok1-app\resources\views/try3.blade.php ENDPATH**/ ?>
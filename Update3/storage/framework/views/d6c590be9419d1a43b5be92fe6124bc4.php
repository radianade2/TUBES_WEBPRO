...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/try.css')); ?>">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 text-center mb-5 p-2" style="border-bottom-style: double; border-width: 5px;">
                <img src="<?php echo e(asset('images/smlogo.png')); ?>" id="Logo" width="300" height="45">
            ...
            <div class="col-9 mx-auto text-center border border-dark rounded mb-2 px-0">
                <form action="<?php echo e(route('proses-input')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <!-- location -->
                    <div class="col-12">
                    ...
                    <div class="col-9 mx-auto text-end px-0">
                        <a type="button" href="/halaman_hasil/{kesimpulan}" class="btn btn-outline-dark mx-auto m-4 border-2 rounded-0" style="font-weight: 500; width: 150px; font-weight: 700;">SUBMIT</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\tubesKelompok1-app\resources\views/try2.blade.php ENDPATH**/ ?>
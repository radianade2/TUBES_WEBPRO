    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-10 mx-auto text-center mb-1 mt-4 px-0">
                <form action="<?php echo e(route('skincare.recommendation')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\coba-app\resources\views/skincare/recommendation.blade.php ENDPATH**/ ?>
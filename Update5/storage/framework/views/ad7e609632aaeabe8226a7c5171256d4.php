            ...
            <div class="col-12 justify-content-center text-center border border-dark mb-5 p-5 px-0">
                ...
                <div class="row mt-5">
                    <div class="col-4">
                        ...
                        Weather Description: <?php echo e($weatherDescription); ?>
                    ...
                    <div class="col-4">
                        ...
                        Temperature: <?php echo e($weatherTemp); ?> °C
                    ...
                    <div class="col-4">
                        ...
                        Wind Speed: <?php echo e($weatherWindSpeed); ?> km/h
